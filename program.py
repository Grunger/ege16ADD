'''!!!Обратите внимание, программа не помогает решить задание, а только 
вычисляет ответ. Вы не сможете пошагово проследить, как решается то
или иное задание, а только увидите результат вычислений.'''
print(''' 
...
print('Значение выражения в десятичной системе счисления: ' + str(answer))

# перевод полученного ответа в любую сс до 16
...
s += num[answer]
s = s[::-1]
print('Число в системе счисления с основанием ' + str(ss) + ': ' + str(s))
